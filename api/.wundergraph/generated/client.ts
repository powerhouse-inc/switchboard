...
import type { SwitchboardGetResponse, SwitchboardGetResponseData } from "./models";
...
export type Queries = {
	"switchboard/get": {
		input?: undefined;
		response: { data?: SwitchboardGetResponseData; error?: OperationErrors["switchboard/get"] };
		requiresAuthentication: false;
		liveQuery: boolean;
	};
};
...
export type Subscriptions = {
	"switchboard/get": {
		input?: undefined;
		response: { data?: SwitchboardGetResponse["data"]; error?: ClientOperationErrors };
		liveQuery: true;
		requiresAuthentication: false;
	};
};

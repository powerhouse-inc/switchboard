...
import { userCrudExtension, sessionCrudExtesnsion, challengeCrudExtension } from './modules';
...
const prisma = prismaBase
  .$extends(userCrudExtension)
  .$extends(sessionCrudExtesnsion)
  .$extends(challengeCrudExtension);

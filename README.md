...
Please navigate to the [`/api`](./api) and then to [`/frontend`](./frontend) directories and follow concrete instructions to start those services separately on two different ports and develop further.
